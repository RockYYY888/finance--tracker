...
function getLatestChartHandlers(): {
	...
	const latestChart = rechartsState.composedCharts[rechartsState.composedCharts.length - 1];
...
function expectPillToContain(label: string, expectedText: string): void {
