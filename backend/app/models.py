...
LIABILITY_CURRENCIES = SUPPORTED_CURRENCIES
...
ASSET_MUTATION_ACTOR_SOURCES = ("USER", "SYSTEM", "API", "AGENT")
...
class AgentRegistration(SQLModel, table=True):
	...
	latest_api_key_name: str | None = Field(default=None, max_length=80)
	created_at: datetime = Field(default_factory=utc_now, nullable=False, index=True)
	updated_at: datetime = Field(default_factory=utc_now, nullable=False, index=True)
...
class AgentTask(SQLModel, table=True):
	id: Optional[int] = Field(default=None, primary_key=True)
	user_id: str = Field(index=True, max_length=32)
	request_source: str = Field(default="USER", index=True, max_length=16)
	api_key_name: str | None = Field(default=None, max_length=80)
...
class AssetMutationAudit(SQLModel, table=True):
	...
	actor_source: str = Field(default="USER", index=True, max_length=16)
	api_key_name: str | None = Field(default=None, max_length=80)
	agent_name: str | None = Field(default=None, max_length=80)
